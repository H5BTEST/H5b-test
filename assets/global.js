...
class ModalDialog extends HTMLElement {
  ...
  show(opener) {
    ...
    if (typeof window.initCustomerVisits === 'function') {
      window.initCustomerVisits();
    }
  }
      ...
      .then((text) => {
        ...
        if (recommendations?.innerHTML.trim().length) {
          ...
          setTimeout(() => {
            ...
            function initRelatedcollectionSwiper(swiperContainer) {
              ...
              var RelatedcollectionSwiper = new Swiper(swiperContainer, {
                ...
                a11y: false,
                navigation: {
                  nextEl: swiperContainer.querySelector(".related-swiper-button-next"),
                  prevEl: swiperContainer.querySelector(".related-swiper-button-prev")
                },
                pagination: {
                  el: swiperContainer.querySelector(".related-swiper-pagination"),
                  clickable: true,
                },
                breakpoints: {
                  320: {
            ...
            setTimeout(() => {
              document.querySelectorAll('.related-slider').forEach(function (swiperContainer) {
                initRelatedcollectionSwiper(swiperContainer);
              });
            }, 100);
        }
